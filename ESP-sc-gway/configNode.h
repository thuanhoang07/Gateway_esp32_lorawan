...
codex decodes[] = {
    {
        0xf182cbfa, "a84041a5f182cbfa",  // Device address and name
        { 0x72, 0x0b, 0x00, 0x20, 0xa7, 0x0b, 0x00, 0x20, 0xa7, 0x0b, 0x00, 0x20, 0xa7, 0x0b, 0x00, 0x20 },  // Network session key
        { 0x73, 0x11, 0x76, 0x7d, 0x4f, 0xd9, 0x26, 0xef, 0xbc, 0x2c, 0xa4, 0x78, 0x3c, 0x3e, 0x5a, 0x7b }   // Application session key
    }
};
#endif //_LOCALSERVER
...
// #define AP_NAME "thuanhoang07"
// #define AP_PASSWD "doanthuxem"


// Gateway Ident definitions. Where is the gateway located?
#define _DESCRIPTION "ESP Gateway"			// Name of the gateway
#define _EMAIL "zz.mr.thuan.zz@gmail.com"		// Owner
#define _PLATFORM "ESP32"
#define _LAT 10.833552
#define _LON 106.713305
